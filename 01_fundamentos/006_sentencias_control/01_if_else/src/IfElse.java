 ...
 *
 * 34. Sentencia de control if - else en java 
 * 35. Ejercicio: if - else en java
 * 36. Ejercicio: cálculo estación del año con if - else
 */
...
public class IfElse {
    ...
    public static void main(String[] args) {
        ...
        // Comprobaciones con expresiones booleanas
