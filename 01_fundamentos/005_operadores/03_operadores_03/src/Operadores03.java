...
public class Operadores03 {
    ...
    public static void main(String[] args) {
         ...
         * comparando la referencia en memoria del objeto que almacena la variable.
         */
         ...
         * 
         * Si queremos comparar el contenido de la cadena, entonces
         * hacemos uso del método 'equals'.
         */
         ...
         * OPERADOR TERNARIO
         * 
         * Simplifica la estructura ya vista 'if-else'.
